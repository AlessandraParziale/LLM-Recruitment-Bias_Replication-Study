...
raw = import_response("./code/replication/RQ/recruit-results/DeepSeek/all-results/combined_results.csv")
pairs = divide(raw)
...
output_path = "./code/replication/RQ/RQ2/DeePseek/results_deepseek-r1_RQ2.txt"
